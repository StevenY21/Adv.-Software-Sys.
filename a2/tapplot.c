...
int main(int argc, char *argv[]) {
    printf("processing args %s", "here1");
    ...
    int c;
    printf("processing args %s", "here2");
    ...
    printf("checking values %s", last_program);
...
libtap.so: observe.o
		gcc -shared -o libtap.so observe.o
tappet: tappet.c
		gcc tappet.c -o tappet -L. -ltap*/
